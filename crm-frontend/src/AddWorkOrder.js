...
export default function AddWorkOrder() {
  ...
  // ✅ refs so removing a chip clears the file input reliably (important!)
  ...
  // ✅ remove chip handlers (clears both state AND the native input value)
  const removePdfFile = () => {
    setPdfFile(null);
    if (pdfInputRef.current) pdfInputRef.current.value = "";
  };
  const removeEstimateFile = () => {
    ...
    <div className="add-workorder-container">
      <form className="add-workorder-card" onSubmit={handleSubmit}>
        ...
        <div className="form-group">
          ...
          />
          <FileChip file={pdfFile} onRemove={removePdfFile} />
        </div>
        ...
        <div className="form-group">
          ...
          <FileChip file={estimatePdfFile} onRemove={removeEstimateFile} />
        </div>
        ...
        <div className="form-group">
          ...
          <input
            ...
            className="form-file-custom"
          />
          <FileChip file={photoFile} onRemove={removePhotoFile} />
        </div>
